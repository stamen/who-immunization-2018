...
var UnderperformersDataProvider =
/*#__PURE__*/
function () {
  function UnderperformersDataProvider(_ref) {
    var underperformersData = _ref.underperformersData;

    _classCallCheck(this, UnderperformersDataProvider);

    this.rows = underperformersData.map(function (d) {
      return {
        dtp3: +d['2018 dtp3'],
  ...
  _createClass(UnderperformersDataProvider, [{
    key: "getRows",
  ...
  return UnderperformersDataProvider;
}();

var _default = UnderperformersDataProvider;
exports.default = _default;
...
},{"d3":"../node_modules/d3/index.js"}],"04_low_performing_scatter/index.js":[function(require,module,exports) {
"use strict";

var d3 = _interopRequireWildcard(require("d3"));

var _underperformers = _interopRequireDefault(require("/data/underperformers.csv"));

var _UnderperformersDataProvider = _interopRequireDefault(require("./UnderperformersDataProvider"));
...
document.addEventListener("DOMContentLoaded", function () {
  Promise.all([d3.csv(_underperformers.default)]).then(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 1),
        underperformersData = _ref2[0];

    var underperformersDataProvider = new _UnderperformersDataProvider.default({
      underperformersData: underperformersData
    });
    var height = 2160,
        width = 4096,
        margin = {
    ...
    var data = underperformersDataProvider.getRows();
    ...
    var xscale = d3.scaleLinear().domain([-50, 50]).range([0, chartWidth]);
    var yscale = d3.scaleLinear().domain([0, 100]).range([chartHeight, 0]);
    var xAxis = d3.axisBottom(xscale);
    var yAxis = d3.axisLeft(yscale);
    [xAxis, yAxis].forEach(function (a) {
      return a.tickFormat(function (d) {
        return "".concat(d, "%");
      });
    });
    var container = plotSVG.append("g").attr("transform", "translate(".concat(margin.left, ",").concat(margin.top, ")"));
    container.append("g").attr("transform", "translate(0,".concat(chartHeight, ")")).attr("class", "axis x").call(xAxis);
    container.append("g").attr("class", "axis y").call(yAxis);
    d3.selectAll("g.axis").style("font-size", "32px"); // Draws threshold lines

    container.append("line").attr("class", "thresholdLine").attr("x2", xscale(-50)).attr("y2", yscale(60)).attr("x1", xscale(50)).attr("y1", yscale(60));
    container.append("line").attr("class", "thresholdLine").attr("x2", xscale(0)).attr("y2", yscale(0)).attr("x1", xscale(0)).attr("y1", yscale(100));
    d3.selectAll("line.thresholdLine").style("stroke", "#333").style("stroke-width", 4);
    var scatterContainer = container.append("g");
    var CIRCLE_RADIUS = 15;
    var UNDER_PERFORMING_CIRCLE_RADIUS = 35; // Draws scatterplot

    scatterContainer.selectAll("circle.country").data(data).enter().append("circle").attr("class", "country").attr("r", function (d) {
      return y(d) < 60 ? UNDER_PERFORMING_CIRCLE_RADIUS : CIRCLE_RADIUS;
    }).attr("cx", function (d) {
      return xscale(x(d));
    }).attr("cy", function (d) {
      return yscale(y(d));
    }).attr("fill", function (d) {
      return (0, _punchColorScale.punchColorScale)(y(d) / 100.0);
    });
    var pointsToLabel = data.filter(function (d) {
      return y(d) < 60;
    }); // Draws labels on countries with less than 60%

    var labelContainer = container.append("g");
    labelContainer.selectAll("text.countryLabel").data(pointsToLabel).enter().append("text").attr("class", "countryLabel").attr("x", function (d) {
      return xscale(x(d)) + CIRCLE_RADIUS;
    }).attr("y", function (d) {
      return yscale(y(d));
    }).style("font-size", "48px").text(function (d) {
      return d.country;
    });
    (0, _renderHelpers.addSVGDownloadLinkBeneath)(plotSVG);
  });
});
},{"d3":"../node_modules/d3/index.js","/data/underperformers.csv":"data/underperformers.csv","./UnderperformersDataProvider":"04_low_performing_scatter/UnderperformersDataProvider.js","/components/renderHelpers":"components/renderHelpers.js","/components/punchColorScale":"components/punchColorScale.js"}],"../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","04_low_performing_scatter/index.js"], null)
//# sourceMappingURL=/04_low_performing_scatter.1d4925ca.js.map