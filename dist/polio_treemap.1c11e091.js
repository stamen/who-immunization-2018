...
exports.default = _default;
},{"d3":"../node_modules/d3/index.js"}],"sketches/polio_treemap/index.js":[function(require,module,exports) {
"use strict";
...
document.addEventListener("DOMContentLoaded", function () {
  Promise.all([d3.csv(_polio_chart.default)]).then(function (_ref) {
    ...
    var width = 1620,
        height = 900;
    var hierarchy = polioDataProvider.getHierarchy();
    var root = d3.treemap().size([width, height]).tile(d3.treemapSliceDice).padding(0)(hierarchy);
    var svg = d3.select("body").append("svg").attr("width", width).attr("height", height);
    svg.append("g").selectAll("rect").data(root.descendants()).enter().append("rect").attr("x", function (d) {
      return d.x0;
    }).attr("y", function (d) {
      return d.y0;
    }).attr("width", function (d) {
      ...
      return polioVacColors[d.data.name] || color;
    }).attr("stroke-width", function (d) {
      return barBorderWidth[d.data.name] || 0;
    }).attr("stroke", 'black');
  });
});
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","sketches/polio_treemap/index.js"], null)
//# sourceMappingURL=/polio_treemap.1c11e091.js.map