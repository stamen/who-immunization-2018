...
var MeaslesDataProvider =
/*#__PURE__*/
function () {
  function MeaslesDataProvider(_ref) {
    var measlesSlopeUpData = _ref.measlesSlopeUpData,
        measlesSlopeDownData = _ref.measlesSlopeDownData,
        measlesData = _ref.measlesData;

    _classCallCheck(this, MeaslesDataProvider);

    this.slopeUpRows = measlesSlopeUpData.map(function (d) {
      return {
        country: d.Country,
        startPercent: +d['2010'],
        endPercent: +d['2018']
    ...
    this.slopeDownRows = measlesSlopeDownData.map(function (d) {
      return {
        country: d.country,
    ...
    this.rows = measlesData.filter(function (d) {
      return d['2010'] !== "" && d['2018'] !== "";
    }).map(function (d) {
      return {
        country: d.country,
        startPercent: +d['2010'],
  ...
  _createClass(MeaslesDataProvider, [{
    key: "getRows",
    ...
    key: "getSlopeUpRows",
    value: function getSlopeUpRows() {
      return this.slopeUpRows;
    }
  }, {
    key: "getSlopeDownRows",
    value: function getSlopeDownRows() {
      return this.slopeDownRows;
    }
  }]);

  return MeaslesDataProvider;
}();

var _default = MeaslesDataProvider;
exports.default = _default;
},{}],"data/measles_slope_up.csv":[function(require,module,exports) {
module.exports = "/measles_slope_up.6ed9d707.csv";
},{}],"data/measles_slope_down.csv":[function(require,module,exports) {
module.exports = "/measles_slope_down.9a86f730.csv";
},{}],"data/measles.csv":[function(require,module,exports) {
module.exports = "/measles.54b214eb.csv";
...
},{"d3":"../node_modules/d3/index.js"}],"components/slopeChart.js":[function(require,module,exports) {
"use strict";
...
function slopeChart(container, props) {
  var width = props.width,
      ...
      data = props.data;
  var enter = container.selectAll("g.slopeItem").data(data).enter();
  enter.append("line").attr("x1", 0).attr("x2", width).attr("y1", y1).attr("y2", y2).style("stroke", stroke).style("stroke-width", 4);
  enter.append("text").attr("x", -3).attr("y", y1).style("text-anchor", "end").style("alignment-baseline", "middle").text(startLabel);
  enter.append("text").attr("x", width + 3).attr("y", y2).style("alignment-baseline", "middle").text(endLabel);
}
...
},{}],"sketches/measles_slope/index.js":[function(require,module,exports) {
"use strict";

var d3 = _interopRequireWildcard(require("d3"));

var _MeaslesDataProvider = _interopRequireDefault(require("./MeaslesDataProvider"));

var _measles_slope_up = _interopRequireDefault(require("/data/measles_slope_up.csv"));

var _measles_slope_down = _interopRequireDefault(require("/data/measles_slope_down.csv"));

var _measles = _interopRequireDefault(require("/data/measles.csv"));

var _punchColorScale = require("/components/punchColorScale");

var _slopeChart = _interopRequireDefault(require("/components/slopeChart"));
...
function renderMeaslesSlope(_ref) {
  var data = _ref.data,
      height = _ref.height,
      width = _ref.width,
      ...
      margin = _ref.margin,
      yscale = _ref.yscale;
  var plotSVG = d3.select("body").append("svg").attr("height", height).attr("width", width);
  plotSVG.style("font-family", "sans-serif").style("font-size", "24px");
  var container = plotSVG.append("g").attr("transform", "translate(".concat(margin.left, ",").concat(margin.top, ")"));
  (0, _slopeChart.default)(container, {
    data: data,
    width: chartWidth,
    y1: function y1(d) {
      return yscale(d.startPercent);
    },
    y2: function y2(d) {
      return yscale(d.endPercent);
    },
    stroke: function stroke(d) {
      return (0, _punchColorScale.punchColorScale)(d.endPercent / 100.0);
    },
    startLabel: function startLabel(d) {
      return "".concat(d.country, " ").concat(d.startPercent);
    },
    endLabel: function endLabel(d) {
      return "".concat(d.endPercent, " ").concat(d.country);
    }
  });
...
document.addEventListener("DOMContentLoaded", function () {
  Promise.all([d3.csv(_measles_slope_up.default), d3.csv(_measles_slope_down.default), d3.csv(_measles.default)]).then(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 3),
        measlesSlopeUpData = _ref3[0],
        measlesSlopeDownData = _ref3[1],
        measlesData = _ref3[2];

    var measlesDataProvider = new _MeaslesDataProvider.default({
      measlesSlopeUpData: measlesSlopeUpData,
      measlesSlopeDownData: measlesSlopeDownData,
    ...
    var height = 2160,
      ...
      left: 500
        ...
        chartHeight = height - margin.top - margin.bottom; //const slopeUpYScale = d3
    //.scaleLinear()
    //.domain([40, 100])
    //.range([chartHeight, 0]);
    //renderMeaslesSlope({
    ...
    var data = measlesDataProvider.getRows();
    var yscale = d3.scaleLinear().domain([25, 100]).range([chartHeight, 0]);
    renderMeaslesSlope({
      data: data,
      height: height,
      width: width,
...
},{"d3":"../node_modules/d3/index.js","./MeaslesDataProvider":"sketches/measles_slope/MeaslesDataProvider.js","/data/measles_slope_up.csv":"data/measles_slope_up.csv","/data/measles_slope_down.csv":"data/measles_slope_down.csv","/data/measles.csv":"data/measles.csv","/components/punchColorScale":"components/punchColorScale.js","/components/slopeChart":"components/slopeChart.js","/components/renderHelpers":"components/renderHelpers.js"}],"../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","sketches/measles_slope/index.js"], null)
//# sourceMappingURL=/measles_slope.8b2a8a39.js.map